...
- (id)init {
    if ((self = [super init])) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(handleDeviceOrientationDidChangeNotification:)
...
- (UIImage*)rotateImageToCurrentOrientation:(UIImage*)image
{
    ...
    {
        UIImageOrientation orientation = (currentOrientation == UIDeviceOrientationLandscapeLeft) ? UIImageOrientationLeft : UIImageOrientationRight;
